...
# Use voice input instead of a fixed destination
...
try:
    ...
    directions = client.directions(
        ...
        destination=destination,  # Voice-input destination
        mode="walking"  # Walking mode
    )
    import json
    print(json.dumps(directions, indent=4))  # Print the full response for debugging
