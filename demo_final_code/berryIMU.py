...
while True:
    ...
    cardinal_direction = get_cardinal_direction(tiltCompensatedHeading)
    ...
    if 1:                       #Change to '0' to stop  showing the heading
        outputString +="\t# HEADING %5.2f  tiltCompensatedHeading %5.2f #" % (heading,tiltCompensatedHeading,cardinal_direction)
